...
#define TM7705_DRDY_PIN                 (65)    // GPIO87/I2S_DI   tm7705的引脚DRDY 
#define TM7705_RESET_PIN                (58)    // GPIO89/I2S_LRCK  tm7705的引脚RESET
...
{
	printk(KERN_DEBUG "tm7705_3 jion \n");
    struct tm7705 *adc;
    int i;
    int status;
 
    adc = kzalloc(sizeof *adc, GFP_KERNEL);
     printk(KERN_ERR "tm7705_3 1 \n");
    ...
    mutex_init(&adc->lock);
    mutex_lock(&adc->lock);
     printk(KERN_ERR"tm7705_3 2 \n");


    spi_set_drvdata(spi, adc);
    printk(KERN_ERR "tm7705_3 3 \n");
